...
const POSTER_SLIDES: PosterSlide[] = [
  ...
  { slug: "bakeries", image: "/discover/posters/bakeries.png", alt: "A baker presenting fresh bread and pastries in a neighborhood bakery", copy: copy({ headline: "Tandirдан yangi uzilgan", cta: "Nonvoyxonalar", label: "Restoranlar" }, { headline: "Прямо из печи", cta: "Найти пекарни", label: "Рестораны" }, { headline: "Fresh from the oven", cta: "Find bakeries", label: "Restaurants" }) },
