...
const copy = {
  uz: {
    ...
    announcements: {
      ...
      marketingTitle: "Marketing va yangiliklar",
      marketingSubtitle: "Chegirmalar e'lon qiling va mijozlarni biznes yangiliklaridan xabardor qiling.",
      createDiscount: "Chegirma yaratish",
      selectService: "Xizmatni tanlang",
      durationDays: "Davomiyligi (kun)",
      publishDiscount: "Chegirmani chop etish",
      needService: "Chegirma xizmatga bog'lanadi. Avval xizmatlar ro'yxatiga kamida bitta faol xizmat qo'shing.",
      composerTitle: "Yangilik chop etish",
      composerPlaceholder: "Biznesingizda qanday yangilik bor? Yangi xizmatlar, jihozlar yoki o'zgarishlar haqida yozing…",
      campaignsTitle: "Chegirmalar",
      updatesTitle: "So'nggi yangiliklar",
      postedAt: "{relative} chop etilgan",
      percentOffMeta: "{n}% chegirma",
      expiresToday: "Bugun tugaydi",
      expiresIn: {
        one: "Tugashiga {n} kun qoldi",
        few: "Tugashiga {n} kun qoldi",
        many: "Tugashiga {n} kun qoldi",
        other: "Tugashiga {n} kun qoldi"
      },
      expired: "Muddati tugagan",
      emptyCampaigns: "Hozircha chegirmalar yo'q.",
      emptyUpdates: "Hozircha yangiliklar yo'q."
    },
    packages: {
  ...
  ru: {
    ...
    announcements: {
      ...
      marketingTitle: "Маркетинг и новости",
      marketingSubtitle: "Публикуйте скидки и рассказывайте клиентам о новостях бизнеса.",
      createDiscount: "Создать скидку",
      selectService: "Выберите услугу",
      durationDays: "Длительность (дни)",
      publishDiscount: "Опубликовать скидку",
      needService: "Скидка привязывается к услуге. Сначала добавьте хотя бы одну активную услугу.",
      composerTitle: "Опубликовать новость",
      composerPlaceholder: "Что нового в вашем бизнесе? Расскажите о новых услугах, оборудовании или изменениях…",
      campaignsTitle: "Скидки",
      updatesTitle: "Последние новости",
      postedAt: "Опубликовано {relative}",
      percentOffMeta: "Скидка {n}%",
      expiresToday: "Истекает сегодня",
      expiresIn: {
        one: "Истекает через {n} день",
        few: "Истекает через {n} дня",
        many: "Истекает через {n} дней",
        other: "Истекает через {n} дня"
      },
      expired: "Срок истёк",
      emptyCampaigns: "Скидок пока нет.",
      emptyUpdates: "Новостей пока нет."
    },
    packages: {
      title: "Услуги и цены",
  ...
  en: {
    ...
    announcements: {
      ...
      marketingTitle: "Marketing & Updates",
      marketingSubtitle: "Publish discounts and keep customers up to date with business news.",
      createDiscount: "Create a discount",
      selectService: "Select a service",
      durationDays: "Duration (days)",
      publishDiscount: "Publish discount",
      needService: "A discount is tied to a service. Add at least one active service first.",
      composerTitle: "Post an update",
      composerPlaceholder: "What's new at your business? Share new services, equipment, or changes…",
      campaignsTitle: "Discounts",
      updatesTitle: "Recent updates",
      postedAt: "Posted {relative}",
      percentOffMeta: "{n}% off",
      expiresToday: "Expires today",
      expiresIn: {
        one: "Expires in {n} day",
        few: "Expires in {n} days",
        many: "Expires in {n} days",
        other: "Expires in {n} days"
      },
      expired: "Expired",
      emptyCampaigns: "No discounts yet.",
