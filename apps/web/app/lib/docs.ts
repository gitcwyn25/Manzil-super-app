...
export type DocId = "about" | "contact" | "terms" | "privacy" | "cookies" | "reviews" | "ai-transparency" | "founders";
...
export const docGroups: Array<{ title: Record<Locale, string>; ids: DocId[] }> = [
  { title: { uz: "Kompaniya", ru: "Компания", en: "Company" }, ids: ["about", "founders", "contact"] },
